...
![Сравнение оптимизаторов при высоком шуме](noisy_comparison.png)
...
![Влияние размера батча](batch_size_ablation.png)
...
![Эволюция ядра](kernel_evolution.png)

### Стандартные условия (MNIST)

![SimpleNet сравнение](simple_comparison.png)

![DeepNet сравнение](deep_comparison.png)

![IllConditioned сравнение](ill_conditioned_comparison.png)
...
Разработано в рамках курса глубокого обучения, 2025
